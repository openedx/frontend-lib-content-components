...
describe('Check React State OLXParser problem', () => {
  ...
  describe('addQuestion method', () => {
    ...
    it('should add a question to the problemState correctly', () => {
